...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            ...
            <td style="width: 25%; color: #444444;">
                <img style="width: 100%;" src="../../img/Logo-BeeuTEC2.png" alt="Logo"><br>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
		<td style="width:50%; "><strong>Dirección:</strong> <br>Cra 2A # 19CN-51 Bosques de pomona, Popayan Cauca<br> Teléfono.: (+57)3146323094</td>
		</tr>
	</table>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        ...
        <table cellspacing="0" style="width: 100%; text-align: left;font-size: 11pt">
        <tr>
             <td style="width:100%; "><br>A continuación Presentamos nuestra oferta que esperamos sea de su conformidad.</td>
        </tr>
    </table>
